...
async def login_with_username(username: str) -> dict | None:
    """Username-only login — no password check. Matches the product spec:
    the autogenerated ID is the sole credential."""
    if not supabase:
        raise RuntimeError("Database not connected.")
